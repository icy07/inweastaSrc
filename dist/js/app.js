    ...
    (() => {
        ...
        let gotoblock_gotoBlock = (targetBlock, noHeader = false, speed = 500, offsetTop = 0) => {
            ...
            if (targetBlockElement) {
                ...
                if ("undefined" !== typeof smooth_scroll_polyfills_min) (new smooth_scroll_polyfills_min).animateScroll(targetBlockElement, "", options);
            }
        };
        ...
        window.onload = function() {
            ...
            if (img) imgWrapper.style.border = `${img.offsetWidth / 2}px solid #0d2f90`;
